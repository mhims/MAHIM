...
export const TEACHERS: Record<string, TeacherProfile> = {
  mahim: {
    ...
    highlights: [
      { label: 'এইচএসসি ২০২৪', value: 'GPA 5.00', subtext: 'বিজ্ঞান বিভাগ, দিনাজপুর শিক্ষা বোর্ড' },
  ...
  suza: {
    ...
    metaTitle: "Abu Saleh Suza (আবু সালেহ সুজা) | মেন্টর — মাহিম'স ক্লাসরুম",
  ...
  swocchol: {
    ...
    englishName: 'Swocchol Kumar Karmokar',
    role: 'মেন্টর — কম্পিউটার সাইন্স ও ম্যাথমেটিক্স',
    institution: 'ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটি (UIU)',
    photoUrl: 'https://res.cloudinary.com/drvyjj7td/image/upload/v1789231884/swocchol_uxtt4r.png',
    bannerGradient: 'from-orange-500 via-amber-500 to-red-500',
    tagline: 'কম্পিউটার সাইন্স এন্ড ইঞ্জিনিয়ারিং | ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটি',
    shortBio: 'ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটির কম্পিউটার সাইন্স এন্ড ইঞ্জিনিয়ারিং (CSE) বিভাগের শিক্ষার্থী ও মাহিম’স ক্লাসরুমের মেন্টর প্যানেলের সম্মানিত শিক্ষক। প্রোগ্রামিং, অ্যালগরিদম ও আধুনিক প্রযুক্তিশিক্ষায় শিক্ষার্থীদের দক্ষ ও আত্মবিশ্বাসী করে গড়ে তোলাই তাঁর মূল লক্ষ্য।',
    metaTitle: "স্বচ্ছল কুমার কর্মকার — মেন্টর, মাহিম'স ক্লাসরুম | শিক্ষক প্রোফাইল",
    metaDescription: "স্বচ্ছল কুমার কর্মকার - কম্পিউটার সাইন্স এন্ড ইঞ্জিনিয়ারিং, ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটি (UIU)। মেন্টর — মাহিম'স ক্লাসরুম।",
    highlights: [
      { label: 'বিষয় / বিভাগ', value: 'CSE (কম্পিউটার সাইন্স এন্ড ইঞ্জিনিয়ারিং)' },
      { label: 'বিশ্ববিদ্যালয়', value: 'ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটি (UIU)' },
      { label: 'প্যানেল', value: "মাহিম'স ক্লাসরুম অফিসিয়াল মেন্টর" }
    ],
    education: [
      {
        institution: 'ইউনাইটেড ইন্টারন্যাশনাল ইউনিভার্সিটি (UIU)',
        degree: 'কম্পিউটার সাইন্স এন্ড ইঞ্জিনিয়ারিং (CSE)',
        status: 'অনার্স অধ্যয়নরত',
        tag: 'CSE Undergrad'
      }
    ],
    teachingPhilosophy: 'কম্পিউটার বিজ্ঞানের মূল ধারণা এবং লজিক্যাল থিংকিংকে বাস্তব প্রজেক্ট ও সহজ উদাহরণের মাধ্যমে শিক্ষার্থীদের মাঝে ছড়িয়ে দেওয়া।'
  }
};
